export function Contact() {
  return `
    <!-- CONTACT SECTION (Edit copy, colors, spacing as you like) -->
      ...
      <div class="max-w-6xl mx-auto grid lg:grid-cols-3 gap-12">
        ...
        <div class="lg:col-span-1 space-y-8">
          ...
          <div class="bg-gray-800/60 border border-gray-700 rounded-2xl p-6">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
              <a
                href="https://github.com/Kimani145" target="_blank" rel="noopener"
              ...
              <a
                href="https://www.linkedin.com/in/joseph-kimani-kim145/" target="_blank" rel="noopener"
                class="group flex items-center gap-2 rounded-xl border border-gray-700 px-3 py-2 hover:bg-gray-800 transition"
                aria-label="LinkedIn"
                title="LinkedIn"
              >
              ...
              <a
                href="mailto:kimnyoski145@gmail.com"
                class="group flex items-center gap-2 rounded-xl border border-gray-700 px-3 py-2 hover:bg-gray-800 transition"
                aria-label="Email"
                title="Email"
              >
        ...
        <div class="lg:col-span-2">
          <form id="contact-form" class="bg-gray-800/60 border border-gray-700 p-8 rounded-2xl shadow-xl space-y-5 max-w-3xl ml-auto">
            ...
            <p id="form-status" class="hidden text-sm mt-3"></p>
          </form>
        </div>
      </div>
